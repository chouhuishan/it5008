/**
 * IT5008 Tutorial 03 (with aggregates)
...
CREATE TABLE open (
  ...
  PRIMARY KEY (bottle_no, wine_name, appellation, vintage),
...
CREATE TABLE taste (
  ...
  FOREIGN KEY (bottle_no, wine_name, appellation, vintage)
    REFERENCES open (bottle_no, wine_name, appellation, vintage)
);
